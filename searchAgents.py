...
def foodHeuristic(state, problem):
  ...
  "*** YOUR CODE HERE ***"
  return len(comida.asList())  # Gets 2/4 on autograder but expands 12517 nodes in ~9"

  # 0/4 on autograder but expands 6126 nodes in ~3"
  Comida = comida.asList()
  Custo = 0
  curPoint = posicao
  while Comer:
    Custo_Heuristico, alimento = \
      min([(util.manhattanDistance(curPoint, alimento), alimento) for alimento in Comer])
    Comer.remove(alimento)
    curPoint = alimento
